...
def load_part1_data(input_file: Path | str | None = None) -> Part1Data:

    # ========================================================
    # 1. LOAD INPUT CSV (CUSTOM OR SAMPLE)
    # ========================================================

    target_file = Path(input_file) if input_file else SAMPLE_INPUT_FILE
    if not target_file.exists():
        target_file = SAMPLE_INPUT_FILE
